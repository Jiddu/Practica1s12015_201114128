 ...
 * @author asus
 */
public class UsuarioZombie extends javax.swing.JFrame {
     LinkedList<NodoZombies> ingreso = new LinkedList<NodoZombies>();

    /**
     * Creates new form Usuario_Zombie
     */
    public UsuarioZombie() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton3.setText("agregar otro campo");
    ...
    NodoZombies jugador = new NodoZombies(this.txtnombrezombie.getText(),Integer.parseInt(this.txtcantidadpersonajesinicial.getText()));
        ingreso.add(jugador);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        NodoZombies jugador = new NodoZombies(this.txtotroscampos.getText());
        ingreso.add(jugador);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuarioZombie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuarioZombie().setVisible(true);
            }
        });
    }
